namespace Jolly
{
	...
	{
		public InstructionOperator(NodeOperator op) { aType = (DataType)op.a.typeInfo.type; bType = (DataType)op.b.typeInfo.type; resultType = (DataType)op.result.typeInfo.type; }
