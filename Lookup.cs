...
static class Lookup 
{
	...
	const DataType.Flags
		...
		UNFINISHED   = DataType.Flags.INSTANTIABLE | DataType.Flags.UNFINISHED,
	...
	public static readonly DataType
		...
		VOID     = new DataType{ name = "void",    size = 0,  align = 0, typeID = 12, flags = 0 },
		STRING   = new DataType{ name = "string",  size = 16, align = 8, typeID = 13, flags = INSTANTIABLE },
		AUTO     = new DataType{ name = "auto",    size = 0,  align = 0, typeID = 14, flags = UNFINISHED },
		TUPLE    = new DataType{ name = "tuple",   size = 0,  align = 0, typeID = 15, flags = INSTANTIABLE },
		TEMPLATE = new DataType{ name = "template", flags = UNFINISHED };
	...
	public static CastLookup casts = new CastLookup() {
		...
		{ I8,  F32, (a,b) => IR.cast<IR_IntToFloat>(a,b, (c,d) => (double)(long)c) },
		{ I8,  F64, (a,b) => IR.cast<IR_IntToFloat>(a,b, (c,d) => (double)(long)c) },
		...
		{ I16, F32, (a,b) => IR.cast<IR_IntToFloat>(a,b, (c,d) => (double)(long)c) },
		{ I16, F64, (a,b) => IR.cast<IR_IntToFloat>(a,b, (c,d) => (double)(long)c) },
		...
		{ I32, F32, (a,b) => IR.cast<IR_IntToFloat>(a,b, (c,d) => (double)(long)c) },
		{ I32, F64, (a,b) => IR.cast<IR_IntToFloat>(a,b, (c,d) => (double)(long)c) },
		...
		{ I64, F32, (a,b) => IR.cast<IR_IntToFloat>(a,b, (c,d) => (double)(long)c) },
